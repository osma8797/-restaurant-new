...
// Must be registered BEFORE routes so API responses include CORS headers.
...
// ---- Static site (serve the HTML pages/images from the repo root)
// This avoids file:// origin issues and makes the booking flow work reliably.
